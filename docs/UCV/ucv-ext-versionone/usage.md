...
| UrbanCode Velocity User Access Key | Secure | The user access key generated from UrbanCode Velocity used to authenticate with the UrbanCode Velocity server. | Yes | No | ucvAccessKey |
