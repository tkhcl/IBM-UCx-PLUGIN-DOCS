...
| Script Resource Properties | String | Resource properties to pass to the script as 
...
not provided, the name of the SQL Server instance running on the server the uDeploy agent is running on is used is used
