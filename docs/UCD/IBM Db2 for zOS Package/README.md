...
This package also discusses how to integrate the services with different SCM systems and how to automate the entire solution. The services use existing plugins in IBM UrbanCode Deploy
...
| :---: | :---: | :---: |
|[All Plugins](../../index.md)|[Deploy Plugins](../README.md)|[7](https://github.com/IBM/Db2ZTools/tree/master/DevOps/Db2%20for%20zOS%20Package%20UCD)|
